...
def jest_test(name, srcs, deps, jest_config, **kwargs):
    """
        ...
        Almost a copy-paste from https://github.com/bazelbuild/rules_nodejs/blob/stable/examples/jest/jest.bzl
    """
    templated_args = [
        "--no-cache",
        "--no-watchman",
    ...
    data = [jest_config] + srcs + deps + ["//tools/jest:jest-reporter.js"]
    _jest_test(
        name = name,
        data = data,
